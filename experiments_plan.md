...
rule calculated feature: Dry_Green_g = GDM_g - Dry_Clover_g, Dry_Total_g = Dry_Clover_g + Dry_Dead_g + Dry_Green_g
...
model inferenced feature: Dry_Clover_g, Dry_Total_g, GDM_g
rule calculated feature: Dry_Green_g = GDM_g - Dry_Clover_g, Dry_Dead_g = Dry_Total_g - (Dry_Clover_g + Dry_Green_g)

exp7


model inferenced feature: Dry_Green_g, Dry_Total_g, GDM_g
rule calculated feature: Dry_Clover_g = GDM_g - Dry_Green_g, Dry_Dead_g = Dry_Total_g - (Dry_Clover_g + Dry_Green_g)
